...
Full pipeline:
  ...
  5. (optional) Compare two camera results and send to AI for interpretation

Usage:
  # Analyse a single chart photo
  result = analyze_chart_photo("camera_a_chart.jpg")

  # Compare two cameras
  comparison = compare_two_cameras("camera_a_chart.jpg", "camera_b_chart.jpg")
"""
